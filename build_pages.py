  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-grid grid">
        <div class="footer-brand">
          <a href="index.html" class="logo mb-1">
            <div style="width: 40px; height: 40px; border-radius: 8px; background: linear-gradient(135deg, var(--color-primary), var(--bg-tertiary)); border: 1px solid rgba(212, 175, 55, 0.5); display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 10px rgba(0,0,0,0.3);">
              <span style="font-family: 'Playfair Display', serif; font-size: 1.8rem; font-weight: 700; background: linear-gradient(90deg, #d4af37, #f3e5ab); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1;">P</span>
            </div>
            <div class="logo-text">Pierce<span>Law</span></div>
          </a>
      ...
      <div class="footer-bottom">
        ...
        <p style="margin-top: 0.5rem; font-size: 0.85rem; color: var(--text-tertiary);">Designed by <a href="https://cybercraftstudio.online" style="color: var(--color-accent); text-decoration: none; font-weight: 500;" target="_blank">cybercraftstudio.online</a></p>
      </div>
    </div>
  </footer>
